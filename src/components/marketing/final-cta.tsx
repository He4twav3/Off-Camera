  ...
  return (
    <section className="relative overflow-hidden">
      <div className="relative mx-auto max-w-[1240px] px-5 py-20 sm:px-6 lg:px-8">
        ...
        <div className="card-featured relative overflow-hidden rounded-[20px] bg-surface-1 px-6 py-20 text-center sm:px-12 sm:py-24">
        ...
        <Reveal>
            ...
            <Reveal delay={BEAT.lede}>
              <p className="mx-auto mt-6 max-w-xl text-[1.0625rem] leading-relaxed text-muted-foreground text-pretty">
                On camera, not showing your face, or completely silent — your face
                doesn&apos;t need to be the product. Start learning the system behind
                content that actually gets watched.
              </p>
            </Reveal>
            <Reveal delay={BEAT.body} className="mt-11 flex justify-center">
              <Button
                size="lg"
                nativeButton={false}
                render={<Link href="/signup" />}
                className="btn-cta group/cta h-auto rounded-full px-11 py-5 text-lg font-bold tracking-tight text-cta-foreground"
              >
                Save your spot
            ...
            <Reveal delay={BEAT.body + BEAT.step}>
              <p className="mt-5 font-mono text-xs tracking-[0.14em] text-signal uppercase">
