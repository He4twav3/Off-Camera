  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div className="flex items-start gap-2 rounded-lg bg-secondary/60 p-3 text-xs text-muted-foreground">
        ...
        <p>
          First time with this email? This creates your account with the
          password you enter. After that, the same password is required to
          sign back in, real accounts, just stored locally for this demo
          instead of in a hosted database.
        </p>
      </div>
    </form>
  );
